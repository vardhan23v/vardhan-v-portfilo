...
let bad = 0;
for (const [w, h] of [[375, 812], [390, 844], [768, 1024]]) {
  await p.setViewport({ width: w, height: h });
  for (const route of ["/", "/paper", "/aurora", "/classic", "/terminal"]) {
...
console.log(bad === 0 ? "NO HORIZONTAL OVERFLOW AT 375/390/768" : bad + " overflows");
await b.close();

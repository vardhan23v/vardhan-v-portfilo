...
const links = [
  ...
  { label: "experience", href: "/terminal#experience" },
  { label: "tech", href: "/terminal#tech" },
  { label: "about", href: "/terminal#about" },
  { label: "mail", href: "/terminal#contact" },
];
  ...
  return (
    <header className="nav">
      <div className="container nav-inner">
        <Link to="/terminal" className="nav-brand" aria-label="Vardhan V — back to shell">
          vardhan&nbsp;.v
        </Link>
